...
//        boolean b = false;
//        if (positions2(line, column)) {
//            for (int i = 0; i < 7; i++) {
//                for (int j = 0; j < 7; j++) {
//                    if (chessBoard.board[i][j] != null && chessBoard.board[i][j].getColor().equals("White")){
//                        if (chessBoard.board[i][j].getColor().equals("Black") &&
//                        chessBoard.board[i][j].canMoveToPosition(chessBoard, i , j, line, column)){
//                            b = true;
//                        }
//                    }
//                    if (chessBoard.board[i][j] != null && chessBoard.board[i][j].getColor().equals("Black")){
//                        if (chessBoard.board[i][j].getColor().equals("White") &&
//                                chessBoard.board[i][j].canMoveToPosition(chessBoard, i , j, line, column)){
//                            b = true;
//                        }
//                    }
...
public boolean isUnderAttack(ChessBoard chessBoard, int line, int column) {
    ...
    public boolean moveKing(ChessBoard chessBoard, int line, int column, int toLine, int toColumn) {
        ...
        if (chessBoard.board[toLine][toColumn] == null || !chessBoard.board[toLine][toColumn].getColor().equals(chessBoard.nowPlayer)) {
            if (plusOne(line, column, toLine, toColumn) && !isUnderAttack(chessBoard, toLine, toColumn)){
